<header>
        ...
        <div class="options-place">
            ...
            ?>
                <div class="item-option" title="Login"><a href="login.php"><i class="fa fa-user-circle-o" aria-hidden="true"></a></i></div>
            ...
            <div class="item-option" title="Mis compras">
                ...
                <a href="pedido.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
            </div>
        </div>
    </header>