                    ...
                    <div style="height: 180px; overflow-y: auto; overflow-x: hidden;">
                        ...
                        ?>
                            <div class="list-group-item checkbox">
                                <label><input type="checkbox" class="common_selector Tipo" value="<?php echo $row['Tipo']; ?>"> <?php echo $row['Tipo']; ?></label>
                            </div>
                        <?php
                        }
    ...
    <script>
        $(document).ready(function() {
            ...
            function filter_data() {
                ...
                $.ajax({
                    url: "servicios/producto/fetch_data.php",
                    method: "POST",
                    data: {
                        action: action,
