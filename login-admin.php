		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="servicios/loginadmin_sql.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Inserte un usuario">
						<input class="input100" type="text" name="Adminuser" placeholder="Admin">
					...
					<div class="wrap-input100 validate-input" data-validate="Inserte una contraseña">
						<input class="input100" type="password" name="Contraseñaadmin" placeholder="Contraseña">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
				...
				<a href="login.php">
					<button class="login100-form-btnadmin" >
						Login para USUARIO
					</button></a>	
			</div>
		</div>
